...
public class HttpRecordCollectConfig {
    ...
    private static final int DEFAULT_BUFFER_QUEUE_SIZE = 50000;

    private static final int DEFAULT_BATCH_SIZE = 100;

    private static final long DEFAULT_BATCH_INTERVAL_MS = 5000L;

    private static final String DEFAULT_STORAGE_DIR = "shenyu-records";
    ...
    public static class RecordConfig {
        ...
        private String storagePath = System.getProperty("user.home")
                + File.separator + DEFAULT_STORAGE_DIR + File.separator;
        ...
        @Override
        public int hashCode() {
            return Objects.hash(storagePath, maxBodySize, batchSize, batchIntervalMs);
        }
    }
}
